          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                ...
                <p className="text-lg sm:text-xl text-gray-600 leading-relaxed animate-fade-in">
                ...
                <div className="flex items-center gap-2 pt-4 animate-fade-in">
              ...
              {[
                ...
                <div key={idx} className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                  ...
                  >
                    ...
                    <ChevronDown
                      size={20}
                      className={`text-[#964F4C] flex-shrink-0 transition-transform ${openFaq === idx ? 'rotate-180' : ''
                        }`}
                    />
                  </button>
                  {openFaq === idx && (
